...
with left:
    st.subheader("Ticker Assistant")
    st.caption("Paste text and process ticker tags directly on this page.")
    ...
    c1, c2 = st.columns(2)
    process_clicked = c1.button("Process Text", use_container_width=True)
...
with right:
    st.subheader("Stock Graph Generator")
    st.caption("Generates the original PNG chart format.")
    ...
    st.caption("Fixed original behavior: latest 365 days only. Put logo at logo/logo.png.")
